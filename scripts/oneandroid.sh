...
_green "Successful installation, the above address login encounter page display 503, wait 1~2 minutes and then refresh to load the page!"
_green "安装成功，上述地址登录遇到网页显示503的，等待1~2分钟后再刷新即可加载页面"
